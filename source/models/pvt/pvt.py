...
class PyramidVisionTransformer(nn.Module):
    def __init__(
        self, img_size=224, patch_size=16, in_chans=Config.Z_NUMBER, num_classes=2, embed_dims=[64, 128, 256, 512],
...
class PVTConstructor(nn.Module):
    def __init__(self, **kwargs):
        super().__init__()
        self.backbone = PyramidVisionTransformer(**kwargs)
        self.neck = FPNNeck(in_channels=[64, 128, 320, 512], out_channels=256, num_outs=4)
        self.head = FPNHead(
...
class PVTMedium(PVTConstructor):
    def __init__(self):
        super().__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
